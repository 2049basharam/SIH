...
const CoordinatorLogin: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== 'coordinator') {
        showToast('Access denied. This login portal is for Coordinators only.', 'error');
        logout();
        setLoading(false);
        return;
      }
      showToast('Welcome to the Coordinator Control Room!', 'success');
    ...
    <div style={styles.container}>
      ...
      <div className="card" style={styles.card}>
        <div style={styles.header}>
          ...
          <h2 style={styles.title}>Coordinator Login</h2>
          <p style={styles.subtitle}>Sign in to manage hackathon events & shortlists</p>
        </div>
        ...
        <form onSubmit={handleLogin}>
          <div className="form-group">
            ...
            <input 
              ...
              placeholder="e.g. coordinator@sih.edu"
              value={email} 
        ...
        <div style={styles.footer}>
          <p style={styles.footerText}>
            Coordinators are provisioned by the College SPOC. Use the invitation link sent to your email to activate.
          </p>
        </div>
      </div>
    </div>
